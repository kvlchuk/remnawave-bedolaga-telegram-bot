    ...
    *,
    ...
    if show_buy:
        keyboard.append(
            [
                InlineKeyboardButton(
                    text=texts.t('START_MENU_BUTTON', 'Начать'),
...
def get_back_keyboard(language: str = DEFAULT_LANGUAGE, callback_data: str = 'back_to_menu') -> InlineKeyboardMarkup:
    texts = get_texts(language)
    return InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=texts.BACK, icon_custom_emoji_id='5258236805890710909', callback_data=callback_data)]])
...
def get_server_status_keyboard(
    ...
    keyboard.append([InlineKeyboardButton(text=texts.BACK, icon_custom_emoji_id='5258236805890710909', callback_data='back_to_menu')])
