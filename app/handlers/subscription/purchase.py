...
def _get_trial_payment_keyboard(language: str, can_pay_from_balance: bool = False) -> types.InlineKeyboardMarkup:
    ...
    keyboard.append([
        ...
        types.InlineKeyboardButton(text=texts.BACK, icon_custom_emoji_id='5258236805890710909', callback_data='menu_trial'),
    ])
...
async def activate_trial(callback: types.CallbackQuery, db_user: User, db: AsyncSession):
    ...
    if getattr(db_user, 'restriction_subscription', False):
        ...
        keyboard.append([
            types.InlineKeyboardButton(text=texts.t('MENU_HOME_BUTTON', 'Меню'), icon_custom_emoji_id='6042137469204303531', callback_data='back_to_menu'),
            types.InlineKeyboardButton(text=texts.BACK, icon_custom_emoji_id='5258236805890710909', callback_data='subscription'),
        ])
        ...
        await callback.message.edit_text(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    ...
                    [
                        types.InlineKeyboardButton(text=texts.t('MENU_HOME_BUTTON', 'Меню'), icon_custom_emoji_id='6042137469204303531', callback_data='back_to_menu'),
                        types.InlineKeyboardButton(text=texts.BACK, icon_custom_emoji_id='5258236805890710909', callback_data='menu_subscription'),
                    ],
                ]
            ),
            parse_mode='HTML',
                ...
                reply_markup=InlineKeyboardMarkup(
                    inline_keyboard=[
                        ...
                        [
                            ...
                            InlineKeyboardButton(text=texts.BACK, icon_custom_emoji_id='5258236805890710909', callback_data='trial_activate'),
                        ],
                    ]
                ),
                parse_mode='HTML',
